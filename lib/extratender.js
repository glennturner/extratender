...
ExtraTender.prototype.drawUserDiscussionCount = function ( d ) {
	...
	for ( var i = 0, num = d.discussions.length; i < num; i++ ) {
		...
		discussionListEle.innerHTML += '<li><a href="' + disc.html_href + '">' + disc.title + '</a><span>' + disc.state + '</span><span>' + disc.comments_count + ' reply</span><span>' + formatted_date + '</span></li>';
	}
