...
ExtraTender.prototype.insertCategoriesAndUsers = function ( discussionId, categoryId, currentUserId ) {	
	// get and insert categories and users
	this.addCategoryHTML( discussionId, categoryId );
	this.addUserHTML( discussionId, currentUserId );
};

ExtraTender.prototype.addCategoryHTML = function ( did, cid ) {	
...
ExtraTender.prototype.onDiscussionClick = function ( e ) {	
	// ignore discussion clicks that are part of a form
	if ( e.srcElement.form || e.srcElement.getAttribute( 'href' ) ) {
		return false;
	}
...
ExtraTender.prototype.drawDiscussion = function ( ele, onSuccess, onError ) {
	...
	this.tender.getDiscussion( discussionId, 
		(function ( json ) {
			...
			this.insertCategoriesAndUsers( discussionId, categoryId, currentUserId );
